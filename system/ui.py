...
#        self.status.resize(self.settings.status_bar_on_top and 1 or y-1, 0, 1, x)
        self.browser.resize(self.settings.status_bar_on_top and 1 or 0, 0, y - 1, x)
        self.taskview.resize(0, 0, y - 1, x)
        self.pager.resize(0, 0, y - 1, x)
        self.status.resize(self.settings.status_bar_on_top and 0 or y-1, 0, 1, x) 
