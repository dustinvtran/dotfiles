...
--#############################################################################
    ...
    awful.key({ modkey }, "a", function () run_or_raise("urxvt -name tcli -g 127x18 -e transmission-remote-cli", { instance = "tcli" }) end),
    --awful.key({ modkey }, "a", function () run_or_raise("urxvt -name tcli -font 'xft:uushi' -boldFont 'xft:uushi' -g 127x18 -e transmission-remote-cli", { instance = "tcli" }) end),
